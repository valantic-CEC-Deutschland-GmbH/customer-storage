 ...
 */
class CustomerGroupToCustomerWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        return [
            CustomerStorageConfig::ENTITY_SPY_CUSTOMER_GROUP_TO_CUSTOMER_CREATE,
            CustomerStorageConfig::ENTITY_SPY_CUSTOMER_GROUP_TO_CUSTOMER_UPDATE,
        ];
    }
}
